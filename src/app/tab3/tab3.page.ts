...
import { IonHeader, IonToolbar, IonTitle, IonContent, IonCard, IonButton, IonItem } from '@ionic/angular/standalone';
...
export class Tab3Page implements OnInit {
  ...
  async getCurrentPosition() {
    ...
    Geolocation.getCurrentPosition(this.options).then(data => {
      ...
      this.latitude = data.coords.latitude ? data.coords.latitude : undefined;
